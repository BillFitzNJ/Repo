...
{
    public class GroupBoxCountMethods : WSGDataAccess
    {
        ...
        public Label LabelCounted = new Label();
        public Label LabelDifference = new Label();
        Label LabelNotes = new Label();
        public Decimal TotalCounted = new decimal();
        ...
        public TextBox TextBoxCounted = new TextBox();
        ...
        public void SetControls()
        {
            ...
            TextTop += TextBoxHeight;
            parentGroupBox.Controls.Add(LabelCounted);
            LabelCounted.Left = 360;
            LabelCounted.Top = TextTop;
            TextTop += TextBoxHeight;
        ...
        public void RefreshTotals()
        {
            foreach (DataRow dr in dt.Rows)
            {
                ...
                TotalCounted = (Convert.ToDecimal(dr["hundreds"]) + Convert.ToDecimal(dr["fiftys"]) + Convert.ToDecimal(dr["twentys"]));
                TotalCounted += (Convert.ToDecimal(dr["tens"]) + Convert.ToDecimal(dr["fives"]) + Convert.ToDecimal(dr["twos"]));
                TotalCounted += (Convert.ToDecimal(dr["ones"]) + Convert.ToDecimal(dr["mixedcoin"]));
                LabelCounted.Text = "Counted: " + TotalCounted.ToString("#,#.00#;(#,#.00#");
            }
