...
{
    public class SmartSafeOutgoingFED : WSGDataAccess
    {
      ...
      FrmSmartSafeBulk  frmSmartSafeBulk = new FrmSmartSafeBulk();
        ...
        {
            countingGroupBoxMethods.ButtonSave.Click += new System.EventHandler(SaveSmartSafeOutgoingFED);
            countingGroupBoxMethods.ButtonCancel.Click += new System.EventHandler(CancelSmartSafeOutgoingFED);

        }

        private void SaveSmartSafeOutgoingFED(object sender, EventArgs e)
        {
            ...
            try
            {
                ExecuteCommand("wsgsp_Insert_smartsafefedout", CommandType.StoredProcedure);
            }
        ...
        private void CancelSmartSafeOutgoingFED(object sender, EventArgs e)
        {
            frmSmartSafeBulk.Close();
        }
